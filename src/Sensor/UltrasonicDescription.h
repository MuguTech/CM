...
#ifndef UltrasonicDescription_h
#define UltrasonicDescription_h
...
struct UltrasonicDescription : public SensorDescription
{
    UltrasonicDescription(string n = "untitled Ultrasonic", float aPositionX = 0.0, float aPositionY = 0.0, float aPositionZ = 1.5, float aRoll = 0.0, float aRange = 10,
